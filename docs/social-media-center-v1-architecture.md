...
新媒体运营中心是“独山子大峡谷 AI 营销中台”的内容增长与用户反馈中枢，面向抖音、快手、微博、微信视频号四个平台，统一管理账号、作品、热点、竞品、评论、AI 建议与内容任务。
...
- 平台枚举：`douyin`、`kuaishou`、`weibo`、`wechat_channels`。
...
|---|---|---|
| id | uuid PK | 账号内部唯一标识 |
| platform | varchar(32) | 平台枚举：抖音、快手、微博、视频号 |
