...
内容监测中心和粉丝分析中心均支持“全部平台、抖音、快手、微博”四种状态，不再纳入视频号数据。全部平台沿用营销中台绿色；抖音使用纯黑主色并搭配红色、青色强调，快手使用纯橙色，微博使用纯红色。平台主题全部使用纯色，不使用渐变；主题只作用于平台 Tab、洞察卡片顶部、图表和关键指标，不改变页面背景或其他模块。
